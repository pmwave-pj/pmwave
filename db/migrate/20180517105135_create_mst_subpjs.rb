class CreateMstSubpjs < ActiveRecord::Migration[5.2]
  def change
    create_table :mst_subpjs, id: false do |t|
      ...
      t.column  :subpj_id, 'INTEGER PRIMARY KEY AUTO_INCREMENT', limit: 8, null: false
